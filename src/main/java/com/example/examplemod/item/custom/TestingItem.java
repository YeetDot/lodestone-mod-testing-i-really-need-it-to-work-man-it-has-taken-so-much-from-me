...
public class TestingItem extends BowItem {
    public TestingItem(Properties pProperties) {
        super(pProperties);
    }
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1)) {
                    ...
                    if (!pLevel.isClientSide) {
                        ...
                        abstractarrow.shootFromRotation(player, player.getXRot(), player.getYRot(), (float)player.getLookAngle().z, f * 3.0F, 0F);
                        if (f >= 1.0F) {
